...
class KVJE:
    ...
    def __init__(self, curve, vertex, edge1, edge2, new_edge=None):

        if curve is not None:
            self.new_edge = Edge(curve)
        else:
    ...
    def execute(self):
        ...
        if self.edge1.he2.vertex == self.vertex:
            he1 = self.edge1.he2
        else:
            he1 = self.edge1.he1
        ...
        he1.loop.he = he1.next
        he2.loop.he = he2.next
